...
export const Nav = () => {
  return (
    <nav style={{display: 'flex', alignItems: 'center', padding: '8px 20px', paddingTop: '18px'}}>
        ...
        <div style={{display: 'flex'}}>
            <span style={{width: '32px', height: '32px', backgroundColor: '#0266da', display: 'block', borderRadius: '50%', color: 'white', marginRight: '20px'}}></span>
