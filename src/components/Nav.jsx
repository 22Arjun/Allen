...
export const Nav = () => {
  return (
    <nav style={{display: 'flex', marginTop: '1.5rem', justifyContent: 'space-between'}}>
        <div>
        ...
        <div style={{display: 'flex', gap: '2rem'}}>
            <span style={{fontSize: '10px', color: 'white', backgroundColor: '#e8900e', borderRadius: '1rem', width: '24px', height: '14px', textAlign: 'center', alignContent: 'center', fontWeight: 700, padding: '0px 6px', position: 'absolute', left: '780px', top: '4px'}}>NEW</span>
            ...
            <NavElements name={'Scholarships'}></NavElements>
            <NavElements name={'ALLEN E-Store'}></NavElements>
            <NavElements name={'More'}></NavElements>
        </div>
        <div>
            <span style={{width: '60px', height: '30px', padding: '8px 16px', border: '1px solid blue', borderRadius: '22px', fontSize: '14px'}}>Login</span>
        </div>
    </nav>
  )
}
